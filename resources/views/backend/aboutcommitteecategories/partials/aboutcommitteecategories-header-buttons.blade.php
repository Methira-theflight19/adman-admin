<!--Action Button-->
@if( Active::checkUriPattern( 'admin/aboutcommitteecategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.aboutcommitteecategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.aboutcommitteecategories.all' ) }}
            </a>
        </li>
        @permission( 'create-aboutcommitteecategory' )
            <li>
                <a href="{{ route( 'admin.aboutcommitteecategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.aboutcommitteecategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
