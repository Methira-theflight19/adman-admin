<!--Action Button-->
@if( Active::checkUriPattern( 'admin/talkdetails' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.talkdetails.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.talkdetails.all' ) }}
            </a>
        </li>
        @permission( 'create-talkdetail' )
            <li>
                <a href="{{ route( 'admin.talkdetails.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.talkdetails.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
