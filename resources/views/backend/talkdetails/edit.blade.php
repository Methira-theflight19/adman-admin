...
@section ('title', trans('labels.backend.talkdetails.management') . ' | ' . trans('labels.backend.talkdetails.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.talkdetails.management') }}
        <small>{{ trans('labels.backend.talkdetails.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($talkdetails, ['route' => ['admin.talkdetails.update', $talkdetails], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-talkdetail']) }}

        <div class="card box box-info">
            <div class="box-header with-border">
                <h3 class="box-title ml-3">{{ trans('labels.backend.talkdetails.edit') }}</h3>
