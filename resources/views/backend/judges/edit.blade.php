...
@endsection
@section ('title', trans('labels.backend.judges.management') . ' | ' . trans('labels.backend.judges.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.judges.management') }}
        <small>{{ trans('labels.backend.judges.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($judges, ['route' => ['admin.judges.update', $judges], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-judge','files' => true]) }}

        <div class="card box box-info">
            <div class="box-header with-border">
                <h3 class="box-title ml-3">{{ trans('labels.backend.judges.edit') }}</h3>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    @include("backend.judges.form")
                    <div class="edit-form-btn">
                        {{ link_to_route('admin.judges.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
