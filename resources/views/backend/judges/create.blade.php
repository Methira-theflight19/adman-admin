...
@endsection
@section ('title', trans('labels.backend.judges.management') . ' | ' . trans('labels.backend.judges.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.judges.management') }}
        <small>{{ trans('labels.backend.judges.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.judges.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-judge','files'=>true]) }}

        <div class="card box box-info">
            <div class="box-header with-border">
                <h3 class="box-title ml-3">{{ trans('labels.backend.judges.create') }}</h3>
