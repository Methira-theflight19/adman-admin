<!--Action Button-->
@if( Active::checkUriPattern( 'admin/activities' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.activities.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.activities.all' ) }}
            </a>
        </li>
        @permission( 'create-activity' )
            <li>
                <a href="{{ route( 'admin.activities.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.activities.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
