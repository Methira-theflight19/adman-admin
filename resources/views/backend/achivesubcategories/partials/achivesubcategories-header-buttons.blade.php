<!--Action Button-->
@if( Active::checkUriPattern( 'admin/achivesubcategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.achivesubcategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.achivesubcategories.all' ) }}
            </a>
        </li>
        @permission( 'create-achivesubcategory' )
            <li>
                <a href="{{ route( 'admin.achivesubcategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.achivesubcategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
