...
@endsection
@section ('title', trans('labels.backend.achivesubcategories.management') . ' | ' . trans('labels.backend.achivesubcategories.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.achivesubcategories.management') }}
        <small>{{ trans('labels.backend.achivesubcategories.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.achivesubcategories.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-achivesubcategory']) }}

        <div class="card box box-info">
            <div class="box-header with-border">
                <h3 class="box-title ml-3">{{ trans('labels.backend.achivesubcategories.create') }}</h3>
