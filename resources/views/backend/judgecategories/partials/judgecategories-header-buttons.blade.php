<!--Action Button-->
@if( Active::checkUriPattern( 'admin/judgecategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.judgecategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.judgecategories.all' ) }}
            </a>
        </li>
        @permission( 'create-judgecategory' )
            <li>
                <a href="{{ route( 'admin.judgecategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.judgecategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
