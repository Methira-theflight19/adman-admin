<!--Action Button-->
@if( Active::checkUriPattern( 'admin/achivecategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.achivecategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.achivecategories.all' ) }}
            </a>
        </li>
        @permission( 'create-achivecategory' )
            <li>
                <a href="{{ route( 'admin.achivecategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.achivecategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
