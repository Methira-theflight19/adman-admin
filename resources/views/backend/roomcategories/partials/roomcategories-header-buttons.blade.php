<!--Action Button-->
@if( Active::checkUriPattern( 'admin/roomcategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.roomcategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.roomcategories.all' ) }}
            </a>
        </li>
        @permission( 'create-roomcategory' )
            <li>
                <a href="{{ route( 'admin.roomcategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.roomcategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
