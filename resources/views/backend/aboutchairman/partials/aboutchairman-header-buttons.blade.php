<!--Action Button-->
@if( Active::checkUriPattern( 'admin/aboutchairman' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.aboutchairman.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.aboutchairman.all' ) }}
            </a>
        </li>
        @permission( 'create-aboutchairman' )
            <li>
                <a href="{{ route( 'admin.aboutchairman.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.aboutchairman.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
