<!--Action Button-->
@if( Active::checkUriPattern( 'admin/galleries' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.galleries.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.galleries.all' ) }}
            </a>
        </li>
        @permission( 'create-gallery' )
            <li>
                <a href="{{ route( 'admin.galleries.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.galleries.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
