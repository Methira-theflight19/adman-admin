<!--Action Button-->
@if( Active::checkUriPattern( 'admin/awardcategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.awardcategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.awardcategories.all' ) }}
            </a>
        </li>
        @permission( 'create-awardcategory' )
            <li>
                <a href="{{ route( 'admin.awardcategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.awardcategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
