...
@endsection
@section ('title', trans('labels.backend.awardcategories.management') . ' | ' . trans('labels.backend.awardcategories.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.awardcategories.management') }}
        <small>{{ trans('labels.backend.awardcategories.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($awardcategories, ['route' => ['admin.awardcategories.update', $awardcategories], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-awardcategory','files' => true]) }}

        <div class="card box box-info">
            <div class="box-header with-border">
                <h3 class="box-title ml-3">{{ trans('labels.backend.awardcategories.edit') }}</h3>
