<!--Action Button-->
@if( Active::checkUriPattern( 'admin/programs' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.programs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.programs.all' ) }}
            </a>
        </li>
        @permission( 'create-program' )
            <li>
                <a href="{{ route( 'admin.programs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.programs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
