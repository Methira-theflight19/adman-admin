<!--Action Button-->
@if( Active::checkUriPattern( 'admin/awardrules' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.awardrules.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.awardrules.all' ) }}
            </a>
        </li>
        @permission( 'create-awardrule' )
            <li>
                <a href="{{ route( 'admin.awardrules.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.awardrules.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
