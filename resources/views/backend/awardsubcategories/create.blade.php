...
@section ('title', trans('labels.backend.awardsubcategories.management') . ' | ' . trans('labels.backend.awardsubcategories.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.awardsubcategories.management') }}
        <small>{{ trans('labels.backend.awardsubcategories.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.awardsubcategories.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-awardsubcategory']) }}

        <div class="card box box-info">
            <div class="box-header with-border">
                <h3 class="box-title ml-3">{{ trans('labels.backend.awardsubcategories.create') }}</h3>
