<!--Action Button-->
@if( Active::checkUriPattern( 'admin/awardsubcategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.awardsubcategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.awardsubcategories.all' ) }}
            </a>
        </li>
        @permission( 'create-awardsubcategory' )
            <li>
                <a href="{{ route( 'admin.awardsubcategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.awardsubcategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
