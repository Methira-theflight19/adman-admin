...
@endsection
@section ('title', trans('labels.backend.aboutcommittees.management') . ' | ' . trans('labels.backend.aboutcommittees.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.aboutcommittees.management') }}
        <small>{{ trans('labels.backend.aboutcommittees.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($aboutcommittees, ['route' => ['admin.aboutcommittees.update', $aboutcommittees], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-aboutcommittee','files' => true]) }}

        <div class="card box box-info">
            <div class="box-header with-border">
                <h3 class="box-title ml-3">{{ trans('labels.backend.aboutcommittees.edit') }}</h3>
