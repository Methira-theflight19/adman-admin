<!--Action Button-->
@if( Active::checkUriPattern( 'admin/talkphotos' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.talkphotos.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.talkphotos.all' ) }}
            </a>
        </li>
        @permission( 'create-talkphoto' )
            <li>
                <a href="{{ route( 'admin.talkphotos.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.talkphotos.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
