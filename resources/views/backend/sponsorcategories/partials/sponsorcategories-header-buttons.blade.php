<!--Action Button-->
@if( Active::checkUriPattern( 'admin/sponsorcategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.sponsorcategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.sponsorcategories.all' ) }}
            </a>
        </li>
        @permission( 'create-sponsorcategory' )
            <li>
                <a href="{{ route( 'admin.sponsorcategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.sponsorcategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
