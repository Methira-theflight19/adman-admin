<!--Action Button-->
@if( Active::checkUriPattern( 'admin/menucategories' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.menucategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.menucategories.all' ) }}
            </a>
        </li>
        @permission( 'create-menucategory' )
            <li>
                <a href="{{ route( 'admin.menucategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.menucategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
