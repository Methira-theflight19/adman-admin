...
@section ('title', trans('labels.backend.awards.management'))

@section('page-header')
    <h1>{{ trans('labels.backend.awards.management') }}</h1>
@endsection

@section('content')
    <div class="card box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.awards.management') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive data-table-wrapper">
                <table id="awards-table" class="w-100 table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
...
@section('after-scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            var dataTable = $('#awards-table').dataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route("admin.awards.get") }}',
                    type: 'post'
                },
                columns: [
